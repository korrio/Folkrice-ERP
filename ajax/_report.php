<?php
    ...
    $header = ['DATE', 'HOTEL/FIRM', 'CODE', 'JOB DESCRIPTION', 'JOB.', 'QTY', 'PRICE', 'AMOUNT', 'PAPER', 'COLOR', 'งานหลังพิมพ์', 'จำนวนเที่ยววิ่ง', 'ช่างอาร์ต', 'เครื่องพิมพ์', 'ช่างพิมพ์', 'COOR', 'NEW/OLD', 'วันที่เสร็จ', 'TEL.'];
