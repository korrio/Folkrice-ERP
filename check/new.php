...
$("[name='tax_id']").keyup(function(event){
		    ...
		    partner: p
                ...
                success: function(data) {
					...
					var myjobno;
			      		...
			      		var str_a1 = ""
						var str_a2 = "";
			      		if(item.tax_id != "" || item.tax_id != null) {
			      			str_a1 = '<a href="../../crm/index.php?pid='+item.partner_id+'">';
							str_a2 = '<img src="paper.gif"/></a> ';
			      		}
	...
	//date_closed = date_closed.substr(0,10);
			      	 	...
			      	 	item.job_no + " " + job_name + '</a></td><td>'+date_open+'</td><td class="partner second">'+str_a1+item.p_name+str_a2+
		...
		$.ajax({
                ...
                success: function(data) {
					...
					if(a[0] == null) {
						...
						window.open("../../../crm/index.php?pid="+data[0].id,"_blank");
